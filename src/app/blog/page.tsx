      ...
      <section className="section bg-cream">
        <div className="site-container">
          {!featured ? (
            <Reveal>
              <div className="border border-stone bg-ivory px-8 py-16 text-center md:px-12 md:py-20">
                ...
                <p className="mx-auto mt-5 max-w-xl leading-relaxed text-olive">
                  We’re preparing market updates and buyer guidance for Central
                  Florida. In the meantime, reach out with any questions about
                  buying or selling.
                </p>
                <Link
                  href="/contact"
            ...
            <>
              <Reveal>
                <article className="grid overflow-hidden border border-stone bg-ivory lg:grid-cols-[1.25fr_1fr]">
              ...
              <div className="mt-16 grid gap-10 lg:grid-cols-12">
                {supporting.map((post, index) => (
                  ...
                  >
                    <article className="group h-full border border-stone bg-cream">
                      <Link
                        href={`/blog/${post.slug}`}
                      ...
                      >
                        ...
                        <div className="p-6 md:p-8">
                          ...
                          <h3 className="display mt-3 text-2xl md:text-3xl transition-colors group-hover:text-burgundy">
                            {post.title}
                          </h3>
